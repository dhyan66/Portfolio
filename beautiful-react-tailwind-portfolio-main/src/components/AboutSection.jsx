      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              I enjoy shipping clean, user-friendly interfaces and building
              data pipelines/dashboards that help teams make better decisions.
            </p>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Building responsive web apps with modern tooling and clean
                    UI.
                  </p>
                </div>
              </div>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    SQL/Python/Excel analysis and dashboards that tell a clear
                    story.
                  </p>
                </div>
              </div>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Requirements gathering, documentation, and process
                    improvement.
                  </p>
                </div>
              </div>
